...
Route::group(['prefix' => 'user', 'namespace' => 'user'], function() {
    ...
    Route::post('register','PageController@DangKy')->name('user.register');
    Route::get('login','PageController@login')->name('user.login');
    Route::post('login','PageController@postDangNhap')->name('user.login');
    Route::get('logout','PageController@LogOut')->name('user.logout');
